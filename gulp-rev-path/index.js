...
function transformFilename(file) {
    ...
    file.path = modifyFilename(file.path, function (filename, extension) {
        ...
        if (extension !== '.css' && extension !== '.js' && !file.revOrigHash) {
            file.revHash = '';
        }
...
plugin.manifest = function (pth, opts) {
    ...
    return through.obj(function (file, enc, cb) {
        ...
        manifest[originalFile] = (opts.fileHash ? revisionedFile : originalFile);
        if (opts.filePath) {
            manifest[originalFile] = opts.filePath + manifest[originalFile];
        }
